...
class DashboardController {
    ...
    private function getDashboardStats($user_id) {
        ...
        $stats['today_amount'] = $today_row['todaysexpense'] ? $today_row['todaysexpense'] : 0;
        ...
        $stats['yesterday_amount'] = $yesterday_row['yesterdayexpense'] ? $yesterday_row['yesterdayexpense'] : 0;
        ...
        $stats['weekly_amount'] = $weekly_row['weeklyexpense'] ? $weekly_row['weeklyexpense'] : 0;
        ...
        $stats['monthly_amount'] = $monthly_row['monthlyexpense'] ? $monthly_row['monthlyexpense'] : 0;
        ...
        $stats['yearly_amount'] = $yearly_row['yearlyexpense'] ? $yearly_row['yearlyexpense'] : 0;
        ...
        $stats['total_amount'] = $total_row['totalexpense'] ? $total_row['totalexpense'] : 0;
